...
<%@ page import="java.sql.*, com.bean.*,com.dao.*" %>    
...
// 		}	
	...
	<div class="products" style="background-color: #E6F9E6;">
        ...
        <form action="./UpdateProductSrv" method="post" >
          ...
          <table border="0">
            <tr><td>Product Name: </td><td><input type="text" name="name"style="font-size: 15px;font-weight: normal; width:80%" value="<%=product.getProdTitle() %>" required></td></tr>
            <tr><td><br></td><td><br></td></tr>
            <tr><td>Product Type&nbsp;</td><td><select name="type" style="font-size: 15px;font-weight: normal; width:80%" value="<%=product.getProdmetaTitle() %>">
            ...
            <tr><td><br></td><td><br></td></tr>            
            <tr><td>Detail Info</td><td><textarea name="info"style="font-size: 15px;font-weight: normal;width: 80%; height: 80px" required><%=product.getProdSummary() %></textarea></td></tr>
            <tr><td><br></td><td><br></td></tr>
            ...
            <tr><td><br></td><td><br></td></tr>
            <tr><td>Picture</td><td>
            	<img src="./img?id=<%=product.getProdId() %>" alt="Product Image" width="200px" height="200px"/></td></tr>
                        <tr><td><br></td><td><br></td></tr>
            <tr colspan="2" align="center"><td><button><a href="adminHome.jsp">Cancel</a></button>&nbsp;</td>
