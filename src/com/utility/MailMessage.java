...
public class MailMessage {
	public static void registrationSuccess(String emailId,String name){
		...
		String htmlTextMessage = ""
				...
				+ ""
				+ "Hi "+name+","
				+ "<br><br>Thanks for singing up with Apni Dukaan.<br>"
	...
	public static void transactionSuccess(String recipientEmail,String name,String transId,double transAmount) {
		...
		String subject = "Order Placed at Apni Dukaan";
		String htmlTextMessage = 
				"<html>" + 
				"  <body>" + 
				"    <p>" + 
				"      Hey "+name+",<br/><br/>" + 
				"      We are glad that you shop with Apni Dukaan!!!!!" + 
				"      <br/><br/>" + 
				...
				"      Come Shop Again! <br/<br/> <font style=\"color:green;font-weight:bold;\">Apni Dukaan.</font>" + 
				"    </p>" + 
				"    " + 
				"  </body>" + 
				"</html>";
	...
	public static void productAvailableNow(String recipientEmail,String name,String prodName, String prodId) {
		String recipient = recipientEmail;
		String subject = "Product "+prodName+" is Now Available at Apni Dukaan";
		String htmlTextMessage = 
				"<html>" + 
				"  <body>" + 
				"    <p>" + 
				...
				"      <br/><br/>" + 
				"      Thanks for shopping with us!<br/><br/>" + 
				"      Come Shop Again! <br/<br/><br/> <font style=\"color:green;font-weight:bold;\">Apni Dukaan.</font>" + 
				"    </p>" + 
				"    " + 
				"  </body>" + 
				"</html>";
